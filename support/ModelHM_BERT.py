...
from support.DatasetHM_BERT import HatefulMemesDataset
from support.Concat_BERT import LanguageAndVisionConcat
...
class HatefulMemesModel(pl.LightningModule):
    ...
    def _build_text_transform(self):
        ...
        #)
        #f.close()
        language_transform = BertTokenizer.from_pretrained('bert-base-cased')
    ...
    def _build_model(self):
        ...
        #)
        language_module = BertModel.from_pretrained('bert-base-cased')
